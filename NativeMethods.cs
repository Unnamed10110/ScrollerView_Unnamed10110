...
internal static class NativeMethods
{
    ...
    // ---- Top-level window enumeration (region detection) ----------------
    ...
    // DWM window attributes used to get accurate frame bounds and to skip
    // cloaked (hidden virtual-desktop / UWP suspended) windows.
